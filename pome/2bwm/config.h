...
static const uint8_t borders[] = {20,21,18,18};
...
static key keys[] = {
    ...
    {  MOD |SHIFT ,       XK_bracketright,          sendtonextworkspace,{}},
    {  MOD |SHIFT ,       XK_bracketleft,          sendtoprevworkspace,{}},
    // Iconify the window
    //{  MOD ,              XK_i,          hide,              {}},
    ...
    {  MOD ,              XK_r,                    start,   SHCMD(TERM " -e lf")},
    //{  MOD,               XK_t,                    start,   SHCMD(TERM " -e newsboat")},
    {  MOD ,              XK_m,                    start,   SHCMD(TERM " -e mocp")},
